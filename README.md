Escape Game - Python Project Documentation
...
Keys and Doors Mapping:

Keys    | Found In                  | Unlocks
Key A     Piano(Game room)            Door A-Bedroom1
Key B     Queen bed(Bedroom1)         Door B-Bedroom2
Key C     Double bed(Bedroom2)        Door C-Living room
Key D     Dresser(Bedroom2)           Door D-Outside
